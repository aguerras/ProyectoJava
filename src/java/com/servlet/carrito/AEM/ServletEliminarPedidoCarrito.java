 ...
 * @author Alexis
 */
@WebServlet(name = "ServletEliminarCarrito", urlPatterns = {"/carritoDeCompras/eliminar"})
public class ServletEliminarPedidoCarrito extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("user") == null) {
            ...
            if(request.getParameter("id_producto") != null) {
                ...
                PedidoDatos.getInstancia().eliminarPedido(id_usuario, id_producto);
            }
